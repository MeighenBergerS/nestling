...
## What a journal club is

A journal club is a regular meeting where one person presents a paper and the group discusses it together.

That is almost the only thing all journal clubs have in common.
Every group runs them differently.
Some groups use slides; many do not.
Some do chalk talks at a whiteboard; others just talk through the paper informally.
Presentations can run ten minutes or an hour, depending on the paper and the group.
Some groups have a fixed format; others have none at all.

Before your first presentation, find out how your specific group runs things.
Ask a senior member what a typical session looks like, whether slides are expected, and how long you have.

---

## What you are actually trying to do

The goal of a journal club presentation is not to give a comprehensive review of a paper.
It is to **start a discussion**.

Everything you say should serve that goal.
You want to give the group just enough to engage with the paper: what it claims, why it is interesting, and what the key results are.
Then get out of the way and let the room talk.

The most successful journal club presentations are not the most polished.
They are the ones that get the group arguing, asking questions, and thinking about how the paper connects to their own work.

---

## Why do we care?

Every presentation should answer one question first: why did you bring this paper?
...
- I found this confusing and I am hoping someone can explain it to me.

All of these are legitimate reasons to present a paper.
The audience does not need to be convinced the paper is important; they need to know why it caught your attention.
That is enough to orient the discussion.
...
!!! tip "The main figure is usually enough"
    Most physics papers have one figure that contains the central result.
    If you understand what that figure shows and can explain why it matters,
    you have what you need to run a good discussion.
    Start there.
...
You do not need to be an expert on the paper to present it.
Thorough preparation is useful, but the bar is lower than you probably think.
...
If you have time, read the methods more carefully and look up one or two references.
If you do not, the above is enough.

---

## Your first presentation

A few things worth knowing before you present for the first time:
...
presentation that leaves no time for anyone to respond.
When in doubt, cover less and stop sooner.
...
!!! note "The discussion is the point"
    A journal club where the presenter talks for 45 minutes and everyone leaves immediately afterwards
    has not really achieved its purpose.
    A ten-minute sketch that leads to an hour of engaged discussion has.
    If you are unsure how long to speak, err shorter.

---

## Using the journal club template

If your group uses slides or a structured format, a starting point is available in the
[Journal Club template](../../templates/journal-club.md).
It includes a suggested slide structure and a set of discussion prompts.

Use it as a scaffold, not a script.
Adapt it freely to your group's style and the paper you are presenting.
