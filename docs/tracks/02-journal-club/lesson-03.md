...
This is backwards.
Your questions are often the most valuable ones in the room, precisely because you are not yet an expert.
A genuine question from someone who does not yet know the answer is more useful than a knowing remark
from someone who has already thought it through.

If something is unclear to you, it is very likely unclear to others.
Asking about it helps everyone, including the presenter.

---

## Asking questions

A good question does one or more of the following:

- Clarifies something that was not explained clearly.
- Points to an assumption that seems worth examining.
- Connects the paper to something outside its scope.
...
Journal club is one of the main places where papers get critically examined before the group
acts on or builds upon their results.
Honest criticism is part of its purpose.

Useful criticism is specific.
"I am not convinced by this result" is a starting point, not a full thought.
"I am not convinced by this result because the error bars seem too small for the sample size" is useful.
"Figure 3 shows X, but that seems inconsistent with the assumption they made in the methods section" is useful.
...
You have learned something, and the group has engaged with the question.

---

## When you disagree with the paper

Scepticism is valuable.
If a result seems implausible, a method seems flawed, or a conclusion seems overstated, say so.
...
Journal club exists partly to develop the critical reading skills needed to evaluate claims independently.
...
A room where people feel comfortable saying "I do not know" and "I might be wrong"
is a room where everyone learns more.
The tone of that room is set by how the audience behaves, not just the presenter.

---

## Taking notes

Notes from journal club discussions are surprisingly useful later.

You do not need to transcribe the whole thing.
...
Attach them to the paper entry in your reference manager
(see [Managing Papers](../01-arxiv/lesson-03.md)).
...
People who ask genuine questions are seen as engaged and curious, not as uninformed.
The question you were afraid to ask is usually the one three other people were also thinking.

Journal club is a low-stakes environment compared to a conference or a group meeting.
It is one of the best places to practise speaking up, asking questions, and forming your own view of a paper.
Use it for that.
