...
A LaTeX paper template is available in `resources/paper-template/`.
A structured outline template is available in [Templates → Paper Outline](../../templates/paper-outline.md).
