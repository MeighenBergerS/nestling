...
When you have many **independent** tasks — running the same simulation with different seeds,
processing different files — `multiprocessing` gives you true CPU parallelism by spawning
