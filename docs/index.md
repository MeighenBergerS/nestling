...
Each track is self-contained. Start with whichever one your supervisor directs you to, or the one closest to what you need right now.

| Track | What you will learn | Start here if… |
| --- | --- | --- |
| [ArXiv & Reading Papers](tracks/01-arxiv/index.md) | Finding, reading, and managing research papers | You have been asked to read papers and don't know where to begin |
| [Journal Club](tracks/02-journal-club/index.md) | Presenting and discussing papers with peers | You have an upcoming journal club presentation |
| [Writing Papers](tracks/03-writing/index.md) | Structure, style, and LaTeX for physics papers | You are drafting your first report or paper |
| [Git & GitHub](tracks/04-git-github/index.md) | Version control and collaborative coding | You are joining a project that uses code |
...
Ready-to-use starting points for common research tasks are in [Templates](templates/index.md).
